...
class App( funciones ):
    ...
    def __init__(self, page = ft.Page ):
        ...
        self.TextTitle = ft.Text( value = self.page.title, weight=ft.FontWeight.BOLD, )
        
        self.BtnPlanillaIrAHoy = ft.IconButton( ft.icons.TODAY, tooltip = 'Ir al día de hoy', on_click= lambda x, route="/", fun=self.ir_a_hoy: self.menu_callback( x, route = route, funcion = fun, title = 'Planilla' ) ) #
        if self.page.route == '/' :
        ...
        self.MainAppBar = ft.AppBar(
                ...
                actions = [
                    ft.IconButton( ft.icons.QUESTION_MARK, tooltip = 'Mostrar Ayuda', on_click=lambda _: self.ayuda() ),
